...
export default function Enroll({ session }: { session: Session | null }) {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setTimeout(() => { setCurrentIndex0((prevIndex) => (prevIndex + 1) % imageSequence_01.rotation.length); }, interval * 1);
      setTimeout(() => { setCurrentIndex1((prevIndex) => (prevIndex + 1) % imageSequence_01.rotation.length); }, interval * 2);
      setTimeout(() => { setCurrentIndex2((prevIndex) => (prevIndex + 1) % imageSequence_01.rotation.length); }, interval * 3);
      setTimeout(() => { setCurrentIndex3((prevIndex) => (prevIndex + 1) % imageSequence_01.rotation.length); }, interval * 4);
      setTimeout(() => { setCurrentIndex4((prevIndex) => (prevIndex + 1) % imageSequence_01.rotation.length); }, interval * 5);
      setTimeout(() => { setCurrentIndex5((prevIndex) => (prevIndex + 1) % imageSequence_01.rotation.length); }, interval * 6);
      setTimeout(() => { setCurrentIndex6((prevIndex) => (prevIndex + 1) % imageSequence_01.rotation.length); }, interval * 7);
      setTimeout(() => { setCurrentIndex7((prevIndex) => (prevIndex + 1) % imageSequence_01.rotation.length); }, interval * 8);
    }, imageSequence_01.interval);

    return () => clearInterval(timer);
  }, [imageSequence_01.rotation, imageSequence_01.interval]);
  ...
  // Professional:  https://enroll.soliditynirvana.com/b/14kcPHg1garv5GM6oq
  // Student:       https://enroll.soliditynirvana.com/b/cN25nfeXc9nrglq3cf
