...
export default function Terms() {
  ...
  return <div className="z-10">
        <div className="container mx-auto px-4">
            <h2 className="text-3xl font-semibold text-gray-800 my-6">Terms of Use for SolidityNirvana LLC</h2>

            <div className="text-gray-700 text-lg space-y-4">
                <i>Version 1.0</i>

                <p>The SolidityNirvana website located at <a href="https://soliditynirvana.com" className="text-green-600 hover:text-green-800">https://soliditynirvana.com</a> is a copyrighted work belonging to SolidityNirvana LLC. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>

                <p>All such additional terms, guidelines, and rules are incorporated by reference into these Terms.</p>

                <p>These Terms of Use described the legally binding terms and conditions that oversee your use of the Site. <strong>BY LOGGING INTO THE SITE, YOU ARE BEING COMPLIANT THAT THESE TERMS and you represent that you have the authority and capacity to enter into these Terms. YOU SHOULD BE AT LEAST 18 YEARS OF AGE TO ACCESS THE SITE. IF YOU DISAGREE WITH ALL OF THE PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE SITE.</strong></p>
                ...
                <h2 className="text-2xl font-semibold text-gray-800 mt-5">Access to the Site</h2>
                ...
                <h2 className="text-2xl font-semibold text-gray-800 mt-5">Third-Party Links & Ads; Other Users</h2>
                ...
                <h2 className="text-2xl font-semibold text-gray-800 mt-5">Disclaimers</h2>
                ...
                <h2 className="text-2xl font-semibold text-gray-800 mt-5">Limitation on Liability</h2>
                ...
                <h2 className="text-2xl font-semibold text-gray-800 mt-5">Copyright Policy.</h2>
                ...
                <h2 className="text-2xl font-semibold text-gray-800 mt-5">General</h2>
                ...
                <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Arizona. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
                ...
                <p>If you have any questions or suggestions about our Terms of Use, do not hesitate to <a href="mailto:hello@soliditynirvana.com" className="text-green-600 hover:text-green-800">contact us</a>.</p>
